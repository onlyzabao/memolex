...
from .forms import PackageCreateForm, WordCreateFormSet
...
class PackageCreateView(LoginRequiredMixin, View):
    def get(self, request):
        ...
        word_formset = WordCreateFormSet()

        context = {"package_form":package_form, "word_formset":word_formset}

        return render(request, "workspace/package_create.html", context)
    
    def post(self, request):
        package_form = PackageCreateForm(data=request.POST)
        word_formset = WordCreateFormSet(data=request.POST)
